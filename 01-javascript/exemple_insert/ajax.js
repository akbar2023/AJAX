...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    function insertEmploye(){
        ...
        // if(!window.XMLHttpRequest) {http = new ActiveXObject("Microsoft.XMLHTTP")} // pour les navigateurs microsoft (edge)
        ...
        if(http.readyState == 4 && http.status == 200) {
            ...
            if(http.responseText == 'OK') {
                document.getElementById("resultat").innerHTML = '<p style="background:green; color:white; padding:5px">L\'employé à bien été ajouté, Bravo !</p>';
